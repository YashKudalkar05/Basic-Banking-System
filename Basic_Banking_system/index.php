...
<!--#F4ECF7 -->
    ...
    <div class="container-fluid myclass" style="padding:0px; margin:0px; ">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#7FFFD4; opacity:1;">
            <img style="border-radius: 0px;" height="90" src="./images/icon1.png">
            &nbsp;
    ...
    <div>
        ...
        <div class="row" style="margin:0px; padding:0px;" >
             ...
             <p class="slideInRight animated"  style="margin:30% auto; letter-spacing: 3px; font-family: 'Lemonada', cursive; font-size: 30px; text-shadow: 2px 3px pink;">->Simple Banking System. <br><a class="view" href="viewallcustomers.php">-> View All Customers</a></p>
