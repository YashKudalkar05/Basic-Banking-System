...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#7FFFD4; opacity:1;"> <!--#7FB3D5, #60105B-->
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <b style="font-size:1.2em;color:#f0fff0;">Sender:</b> <span style="font-size:1.2em;"><input id="myinput" name="sender" disabled type="text" style="width:40%;border:none; border-radius: 30px; background-color: #F9EBEA;" value='<?php echo "$user";?>'></input></span>
                        ...
                        <br><br><br>
                        <b style="font-size:1.2em; color:#f0fff0;">Receiver:</b>
                <select name="receiver" style="border-radius: 30px; background-color: #F9EBEA;" id="dropdown" required>
                    <option>Name</option>
                <?php
