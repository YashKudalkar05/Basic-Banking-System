...
<div class="usertable">
    ...
    <table id="myTable" style="border: 7px solid #40D0E0;">
          <tr style='font-size: 20px; letter-spacing:1.5px; text-align:center; align-content: center; border-collapse: collapse; margin:auto; border-color:#00FFFF;'>
            <th style="background-color: #F5FFFA; border: 5px solid #00FFFF ;">Transfer ID</th>
            <th style="background-color: #F5FFFA; border: 5px solid #00FFFF ;">Sender</th>
            <th style="background-color: #F5FFFA; border: 5px solid #00FFFF ;">Receiver</th>
            <th style="background-color: #F5FFFA; border: 5px solid #00FFFF ;">Amount</th>
